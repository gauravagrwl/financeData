...
public enum InstitutionTypeEnum {
     ...
     */
    private InstitutionTypeEnum(InstitutionCategoryEnum accountCategory, String accountTypeName, String accountTypeCode) {
    ...
    public EnumSet<InstitutionTypeEnum> BankingEnumSet() {
        return EnumSet.of(InstitutionTypeEnum.CHECKING, InstitutionTypeEnum.SAVING, InstitutionTypeEnum.DEPOSIT,
                InstitutionTypeEnum.PPF, InstitutionTypeEnum.CREDIT);
    }
}
